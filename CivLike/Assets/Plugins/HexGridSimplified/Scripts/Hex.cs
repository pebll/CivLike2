...
namespace Wunderwunsch.HexGridSimplified
{
    ...
    public static class Hex
    {
        ...
        public static void SetMapAttributes(Vector2Int mapSize, bool wrapsHorizontal)
        {
            Hex.wrapsHorizontal = wrapsHorizontal;
            Hex.mapSize = mapSize;
        }
        ...
        /// <param name="removeInvalid">wraps coordinates (if map wraps around) and removes out all results which are out of bound</param>
        /// <returns></returns>
        public static List<Vector3Int> GetLine(Vector3Int origin, Vector3Int target, float horizontalNudgeFromOriginCenter, int trimStart, int trimEnd, bool removeInvalid) //maybe add option to only return those in mapBounds
        {
            if(WrapsHorizontal)
            {
        ...
        public static HashSet<Vector2Int> GetMirroredTileCoordinates(Vector2Int originalCoord, bool mirrorHorizontal, bool mirrorVertical, bool includeOriginal, bool removeInvalid)
        {
        ...
        public static HashSet<Vector3Int> GetMirroredTileCoordinates(Vector3Int originalCoord, bool mirrorHorizontal, bool mirrorVertical, bool includeOriginal, bool removeInvalid )
        {
        ...
        /// <returns></returns>
        public static Vector3Int ClampToVerticalBounds(Vector3Int position)
        {
            Vector2Int offsetCoord = HexConverter.CubeCoordToOffsetCoord(position);            
        ...
        public static HashSet<Vector3Int> GetBorderEdgesOfSetOfTiles(IEnumerable<Vector3Int> tiles)
        {            
        ...
        /// <returns></returns>
        public static Vector3Int WrapTileHorizontal(Vector3Int position)
        {
        ...
        public static Vector3Int WrapEdgeHorizontal(Vector3Int position)
        {
